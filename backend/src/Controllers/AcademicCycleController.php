...
use App\Repositories\AcademicCycleRepositoryMySQL;

class AcademicCycleController {
    private $repository;

    public function __construct() {
        $this->repository = new AcademicCycleRepositoryMySQL();
    }
    ...
    public function create(Request $request, Response $response, $args) {
        ...
        if ($success) {
            $response->getBody()->write(json_encode(['status' => 'success', 'message' => 'Ciclo creado']));
    ...
    public function update(Request $request, Response $response, $args) {
        ...
        if ($success) {
            $response->getBody()->write(json_encode(['status' => 'success', 'message' => 'Ciclo actualizado']));
            return $response->withHeader('Content-Type', 'application/json')->withStatus(200);
        }
