...
class SubjectRepositoryMySQL {
    ...
    public function create(array $data) {
        ...
        $sql = "INSERT INTO subjects (name, program, career_id, academic_year, quarter, duration, weekly_hours) 
                VALUES (:name, :program, :career_id, :academic_year, :quarter, :duration, :weekly_hours)";
        $stmt = $this->db->prepare($sql);
    ...
    public function update($id, array $data) {
        ...
        $sql = "UPDATE subjects SET name = :name, program = :program, career_id = :career_id, 
                academic_year = :academic_year, quarter = :quarter, duration = :duration, weekly_hours = :weekly_hours WHERE id = :id";
        $stmt = $this->db->prepare($sql);
